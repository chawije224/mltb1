...
from bot import bot, IMAGE_URL, app, dispatcher, updater, botStartTime, IGNORE_PENDING_REQUESTS, alive, LOGGER, Interval, rss_session, INCOMPLETE_TASK_NOTIFIER, DB_URI
...
def stats(update, context):
    ...
    stats = f'<b>╭──</b>《🌐<b> Bot Statistics 🌐</b>》\n' \
            f'<b>│</b>\n' \
...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Group", "https://t.me/SLTorrentingCorp")
    buttons.buildbutton("Channel", "https://t.me/BotHelpSLTC")
...
'''
        ...
        sendMarkup('Join our group to use me!!', context.bot, update.message, reply_markup)
